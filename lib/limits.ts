...
export async function checkUsageLimit(...args: any[]) { return { allowed: true, remaining: 999999 } as any; }
export async function getPlan(...args: any[]) { return { name: 'unlimited', isUnlimited: true } as any; }
export async function getLimits(...args: any[]) { return { maxProjects: 999999, maxProposals: 999999 } as any; }
export async function getProjectCount(...args: any[]) { return 0 as any; }
export async function getUsage(...args: any[]) { return { used: 0, limit: 999999, isUnlimited: true } as any; }
...
export async function checkUsageLimit_ORIG(
