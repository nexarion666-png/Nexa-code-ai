 ...
 async function send(){
  ...
  try{
   ...
   await loadChat(activeChatId);
    setNotice(mode === 'agent' ? 'Proposal ready for review…' : 'Complete');
  }catch(e){
